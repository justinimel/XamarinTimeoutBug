...
extern void *mono_aot_module_TimeoutIssueExample_iOS_info;
extern void *mono_aot_module_Xamarin_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_System_info;
extern void *mono_aot_module_System_Core_info;
extern void *mono_aot_module_Mono_Dynamic_Interpreter_info;
extern void *mono_aot_module_Acr_MvvmCross_Plugins_UserDialogs_info;
...
extern void *mono_aot_module_TimeoutIssueExample_info;
extern void *mono_aot_module_System_Net_Http_info;
extern void *mono_aot_module_Cirrious_MvvmCross_Plugins_Messenger_info;
extern void *mono_aot_module_Newtonsoft_Json_info;
extern void *mono_aot_module_System_Runtime_Serialization_info;
extern void *mono_aot_module_ModernHttpClient_info;
extern void *mono_aot_module_Acr_MvvmCross_Plugins_UserDialogs_Touch_info;
extern void *mono_aot_module_BTProgressHUD_info;

void xamarin_register_modules ()
{
	mono_aot_register_module (mono_aot_module_TimeoutIssueExample_iOS_info);
	mono_aot_register_module (mono_aot_module_Xamarin_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_System_info);
	mono_aot_register_module (mono_aot_module_System_Core_info);
	mono_aot_register_module (mono_aot_module_Mono_Dynamic_Interpreter_info);
	mono_aot_register_module (mono_aot_module_Acr_MvvmCross_Plugins_UserDialogs_info);
	...
	mono_aot_register_module (mono_aot_module_TimeoutIssueExample_info);
	mono_aot_register_module (mono_aot_module_System_Net_Http_info);
	mono_aot_register_module (mono_aot_module_Cirrious_MvvmCross_Plugins_Messenger_info);
	mono_aot_register_module (mono_aot_module_Newtonsoft_Json_info);
	mono_aot_register_module (mono_aot_module_System_Runtime_Serialization_info);
	mono_aot_register_module (mono_aot_module_ModernHttpClient_info);
	mono_aot_register_module (mono_aot_module_Acr_MvvmCross_Plugins_UserDialogs_Touch_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "TimeoutIssueExample.iOS.exe";
